...
/* package hs-tools-0.1.0.0 */
#define VERSION_hs_tools "0.1.0.0"
#define MIN_VERSION_hs_tools(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package turtle-1.2.8 */
#define VERSION_turtle "1.2.8"
...
#define CURRENT_COMPONENT_ID "hs-tools-0.1.0.0-5YAGT2SFWXRITFy6S0pa8V"

#define CURRENT_PACKAGE_KEY "hs-tools-0.1.0.0-5YAGT2SFWXRITFy6S0pa8V"
